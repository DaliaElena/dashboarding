...
export const API_URL_DATA_SOURCE: string = 'https://4wfr3j5pz4quixveyazqmwobvm0rqlmi.lambda-url.us-east-1.on.aws/data_source';
...
export const API_URL_WORKERS_CARDS: string = 'https://4wfr3j5pz4quixveyazqmwobvm0rqlmi.lambda-url.us-east-1.on.aws/workers_cards';
export const API_URL_DASHBOARDS: string = 'https://4wfr3j5pz4quixveyazqmwobvm0rqlmi.lambda-url.us-east-1.on.aws/dashboards';
export const JUPYTER_INSTANCE: string = 'http://notebook.netjerdbos.cloud/login?next=%2Ftree'
export const DOCUMENTATION: string = 'https://4wfr3j5pz4quixveyazqmwobvm0rqlmi.lambda-url.us-east-1.on.aws/dbos_info'